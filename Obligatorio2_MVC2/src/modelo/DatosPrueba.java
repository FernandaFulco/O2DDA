...
//AGREGAR EL OBSERVER PARA QUE SE ACTUALIECE EN TODAS LAS VENTANAS CUANTOS JUGADORES FALTAN.
        ...
        sistema.agregarUsuarioJugador(20000, "f", "f", "f");
        sistema.agregarUsuarioJugador(20000, "x", "x", "x");
        sistema.agregarUsuarioJugador(30000, "y", "y", "y");
        sistema.agregarUsuarioJugador(40000, "m", "m", "m");
        sistema.agregarUsuarioJugador(50000, "a", "a", "a");
